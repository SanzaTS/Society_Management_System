...
$paypal_email = 'sb-saznk6216280@business.example.com';
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Make instant payments</li>
                        </ol>

                        <div class="card-body">
                        <form  class="paypal" action="request.php" method="post" id="paypal_form" target="_blank">
                                      ...
                                      <!--  <label class="small mb-1" for="inputEmailAddress">Member Name</label>  -->
                                        <input class="form-control py-4" name="user" id="inputEmailAddress" type="hidden" aria-describedby="emailHelp" value="<?php echo $id; ?>"/>
                                        </div>
                                           <div class="form-group">

                                                <label class="small mb-1" for="inputEmailAddress">Member Name</label>
                                                <input class="form-control py-4" name="name" id="inputEmailAddress" type="text" aria-describedby="emailHelp" value="<?php echo $fullName; ?>"/>
                                            </div>
                                            <div class="form-group">
