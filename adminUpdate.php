                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">View and Update Profile</li>
                        </ol>
                        <?php

                            $query = "select a.name,a.surname,a.id,a.cell_no,a.gender,u.email from admin a, user u WHERE a.userId = u.userId AND u.email = '$name' ";
