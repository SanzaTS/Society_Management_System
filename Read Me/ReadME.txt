...
Chnages are as follows

The user apply for claim

Confirmation is sent to email

Admin reviw the application 
Admin approve or reject application

THe confirmation is sent to user

When the user apply for claimthe staus change to inactive
